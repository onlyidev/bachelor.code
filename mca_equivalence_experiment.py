...
class Experiment:
    ...
    def __loadData(self, random_state=42):
        ...
        df_obf = self.mca.predict(df_obf)
    ...
    def run(self):
        ...
        disp.plot().figure_.savefig(m_params["mca_equiv_confusion"])
        self.notifier.upload([m_params["mca_equiv_confusion"]], "MCA Equivalence Confusion Matrix")
        with open(m_params["mca_equiv"], "w") as f:
